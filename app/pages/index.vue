...
<template>
  <div class="h-full w-full  bg-black sm:h-screen" data-theme="dark">
    <div class="flex h-fit w-full flex-col items-center justify-center border bg-[url(/cover.jpg)] bg-cover bg-fixed bg-center bg-no-repeat">
      <header class="sticky top-0 z-100 mx-auto flex h-18 max-h-18 w-full max-w-7xl self-stretch bg-base-200/60 px-16 py-4 shadow-lg">
      ...
      <div class="my-8 flex h-full w-full max-w-7xl flex-col items-center justify-evenly px-5 xl:flex-row xl:p-2">
        <div class="text-center text-white xl:text-left ">
          ...
          <h1>
            <span class="text-rotate text-3xl leading-loose duration-20000 sm:text-4xl lg:text-5xl">
          ...
          <p class="mt-4 h-fit px-4 text-xl lg:text-2xl xl:px-0">
            <span class="font-serif text-lg font-light capitalize italic">&ldquo;Powered by passion, ruled by Best Practices, forged by action&rdquo;</span>
            <br>
            As an agile full-stack developer with 25+ years of professional engagement, I enjoy to commit myself to engaging, challenging software development projects and teams!
          </p>
